...
# 预设零位配置
# SDK读取的原始值（千分度单位，即: 实际度数 * 1000）
# PRESET_ZERO_J1_RAW = 1411      # Joint 1: 1.411°
# PRESET_ZERO_J2_RAW = 8211      # Joint 2: 8.211°
# PRESET_ZERO_J3_RAW = -39652    # Joint 3: -39.652°
# PRESET_ZERO_J4_RAW = -8139     # Joint 4: -8.139°
# PRESET_ZERO_J5_RAW = 30782     # Joint 5: 30.782°
# PRESET_ZERO_J6_RAW = 6237      # Joint 6: 6.237°

#均爲0
PRESET_ZERO_J1_RAW = 0
PRESET_ZERO_J2_RAW = 0
PRESET_ZERO_J3_RAW = 0
PRESET_ZERO_J4_RAW = 0
PRESET_ZERO_J5_RAW = 0
PRESET_ZERO_J6_RAW = 0

# 转换为实际度数（用于显示）
PRESET_ZERO_J1 = PRESET_ZERO_J1_RAW / 1000.0
PRESET_ZERO_J2 = PRESET_ZERO_J2_RAW / 1000.0
PRESET_ZERO_J3 = PRESET_ZERO_J3_RAW / 1000.0
PRESET_ZERO_J4 = PRESET_ZERO_J4_RAW / 1000.0
PRESET_ZERO_J5 = PRESET_ZERO_J5_RAW / 1000.0
PRESET_ZERO_J6 = PRESET_ZERO_J6_RAW / 1000.0
...
def go_zero():
    ...
    # 3. 发送回零命令（移动到预设位置）
    print("开始回零...")
    print(f"  目标位置: J1={PRESET_ZERO_J1:.3f}°, J2={PRESET_ZERO_J2:.3f}°, J3={PRESET_ZERO_J3:.3f}°")
    print(f"           J4={PRESET_ZERO_J4:.3f}°, J5={PRESET_ZERO_J5:.3f}°, J6={PRESET_ZERO_J6:.3f}°")
    print(f"  SDK单位: J1={PRESET_ZERO_J1_RAW}, J2={PRESET_ZERO_J2_RAW}, J3={PRESET_ZERO_J3_RAW}")
    print(f"           J4={PRESET_ZERO_J4_RAW}, J5={PRESET_ZERO_J5_RAW}, J6={PRESET_ZERO_J6_RAW}")
    piper.MotionCtrl_2(0x01, 0x01, 50, 0x00)  # 速度50
    piper.JointCtrl(PRESET_ZERO_J1_RAW, PRESET_ZERO_J2_RAW, PRESET_ZERO_J3_RAW, 
                    PRESET_ZERO_J4_RAW, PRESET_ZERO_J5_RAW, PRESET_ZERO_J6_RAW)
